 ...
 * Use the [VehicleAddingCompletedFragment.newInstance] factory method to
...
class VehicleAddingCompletedFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment VehicleAddingCompletedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            VehicleAddingCompletedFragment().apply {
